...
import cn.aaron911.micro.im.webserver.payload.JoinRequest;
...
@Component
@Slf4j
public class ImWebSocketServerHandler {
    ...
    public void onConnect(SocketIOClient client) {
        if (client != null) {
            ...
            sessionManager.createSession(userId, client);
    ...
    public void onDisconnect(SocketIOClient client) {
        if (client != null) {
            ...
            String userId = client.getHandshakeData().getSingleUrlParam("token");
            UUID sessionId = client.getSessionId();
            sessionManager.removeSession(sessionId.toString());
